...
export default function Navbar() {
  ...
  return (
    <header className="relative z-20 w-full border-b border-border bg-background/90 shadow-lg shadow-foreground/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-border lg:border-border lg:backdrop-blur-sm lg:after:hidden">
